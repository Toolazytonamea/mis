                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <select name="esex" class="selectpicker form-control">
										<option value="男" id="opt1">男</option>
										<option value="女" id="opt2">女</option>
									</select>
                                </div>                     
                            </div>
                        </div>
                         ...
                         <div class="row">
                            <div class="form-group">
                                <div class="col-sm-3 col-sm-offset-3 text-right">
                                    <button type="button" class="btn btn-primary" onclick="updateEmployee();"><i class="fa fa-save"></i> 保存内容</button>
                                </div>
                                <div class="col-sm-3">
