...
<body class="gray-bg">
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form id="imageForm" method="post" action="${pageContext.request.contextPath}/emp/updateLogo" enctype="multipart/form-data" class="form-horizontal">
                    	   <div class="row">
                         ...
                         <div class="row">
                            <div class="form-group">
                                <div class="col-sm-3 col-sm-offset-3 text-right">
                                    <button type="button" class="btn btn-primary" onclick="updateLogo();">保存内容</button>
                                </div>
                                <div class="col-sm-3">
   ...
   <script>
       ...
       function updateLogo(){
           ...
           $("#imageForm").ajaxForm();
           $("#imageForm").ajaxSubmit(function(rs){
              if(rs.status==200){
                  $("#pic").attr("src",rs.data);
